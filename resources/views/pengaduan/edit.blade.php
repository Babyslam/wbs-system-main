    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-body">
                    <form role="form" method="POST" action="{{ url('admin/pengaduan/' . $pengaduan->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Perihal" name="perihal"
                                        ...
                                        value="{{ old('perihal') ?? $pengaduan->perihal }}">
                                    @error('perihal')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Jabatan Terlapor"
                                        ...
                                        value="{{ old('jabatan_terlapor') ?? $pengaduan->jabatan_terlapor }}">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Perangkat Daerah"
                                        ...
                                        value="{{ old('perangkat_daerah') ?? $pengaduan->perangkat_daerah }}">
                                ...
                                <div class="mb-3">
                                    <input type="date" class="form-control" name="tanggal_kejadian" id="tanggal_kejadian"
                                        ...
                                        value="{{ old('tanggal_kejadian') ?? $pengaduan->tanggal_kejadian }}">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <textarea class="form-control" placeholder="Detail Kejadian" name="detail_kejadian" id="detail_kejadian"
                                        aria-label="detail_kejadian" aria-describedby="detail_kejadian" rows="3">{{ old('detail_kejadian') ?? $pengaduan->detail_kejadian }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <select class="form-control" name="status_pengaduan" id="status_pengaduan"
                                        aria-label="status_pengaduan" aria-describedby="status_pengaduan"
                                        value="{{ old('status_pengaduan') ?? $pengaduan->status_pengaduan }}">
                                        <option value="" selected disabled>Status</option>
                                        <option value="disetujui"
                                            {{ 'disetujui' == (old('status_pengaduan') ?? $pengaduan->status_pengaduan) ? 'selected' : '' }}>
                                            Setujui</option>
                                        <option value="ditolak"
                                            {{ 'ditolak' == (old('status_pengaduan') ?? $pengaduan->status_pengaduan) ? 'selected' : '' }}>
                                            Tolak</option>
                                    </select>
