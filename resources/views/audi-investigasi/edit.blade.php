    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-body">
                    <form role="form" method="POST" action="{{ url('admin/audit-investigasi/' . $pengaduan->id) }}"
                            ...
                            <div class="col-md-6 ">
                                <div class="mb-3">
                                    <textarea class="form-control" placeholder="Ringkasan Hasil Audit" name="ringkasan_hasil_audit"
                                        ...
                                        rows="4">{{ old('ringkasan_hasil_audit') ?? ($pengaduan->audit->ringkasan_hasil_audit ?? null) }}</textarea>
                                ...
                                <div class="mb-3">
                                    <textarea class="form-control" placeholder="Rekomendasi" name="rekomendasi" id="rekomendasi"
                                        aria-label="rekomendasi" aria-describedby="rekomendasi" rows="6">{{ old('rekomendasi') ?? ($pengaduan->audit->rekomendasi ?? null) }}</textarea>
                                    @error('rekomendasi')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
