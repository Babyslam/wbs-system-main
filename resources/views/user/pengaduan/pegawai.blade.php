        ...
        <main class="py-4">
            ...
            <div class="p-5">
                <div class="container rounded-4 p-4 bg-white">
                    <form action="/pengaduan/pegawai" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3 d-flex gap-3 flex-wrap">
                            ...
                            <div class="col-10">
                                ...
                                <div class="mb-3 row">
                                    <label for="nik"
                                        class="col-sm-3 col-form-label fs-sm d-flex align-items-center">NIP</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control bg-gray-1 py-3" id="nik"
                                            placeholder="Masukkan NIP anda" name="nomor_identitas"
                                ...
                                <div class="mb-3 row">
                                    <label for="email"
                                        ...
                                        Daerah</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control bg-gray-1 py-3" id="asal"
                                            placeholder="Masukkan perangkat daerah anda" name="asal"
                                            value="{{ old('asal') }}" />
                                        @error('asal')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control bg-gray-1 py-3" id="no_telp"
                                            placeholder="No. Telp" name="nomor_telepon"
                                ...
                                <div class="mb-3 row">
                                    <label for="tanda_pengenal"
                                        class="col-sm-3 col-form-label fs-sm d-flex align-items-center">Upload SPMT/SK
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="col-md-6 d-flex justify-content-center">
                                <button type="submit" name="role" value="pegawai"
