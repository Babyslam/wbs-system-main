                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bg-gray-1 py-3" id="perihal"
                                        placeholder="Perihal" name="perihal" value="{{ $pengaduan->perihal }}" disabled />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bg-gray-1 py-3" id="nama_terlapor"
                                        ...
                                        value="{{ $pengaduan->nama_terlapor }}" disabled />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="jabatan"
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bg-gray-1 py-3" id="jabatan"
                                        ...
                                        value="{{ $pengaduan->jabatan_terlapor }}" disabled />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="perangkat_daerah"
                                    ...
                                    Daerah</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bg-gray-1 py-3" id="perangkat_daerah"
                                        placeholder="Perangkat Daerah" name="perangkat_daerah"
                                        value="{{ $pengaduan->perangkat_daerah }}" disabled />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="tempat"
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bg-gray-1 py-3" id="tempat"
                                        ...
                                        value="{{ $pengaduan->tempat_kejadian }}" disabled />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="tanggal"
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bg-gray-1 py-3" id="tanggal"
                                        ...
                                        value="{{ $pengaduan->tanggal_kejadian }}" disabled />
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control bg-gray-1 py-3" id="detail_kejadian" placeholder="Detail kejadian yang dilaporkan"
                                        rows="5" name="detail_kejadian" disabled>{{ $pengaduan->detail_kejadian }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
